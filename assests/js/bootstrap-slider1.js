...
$(document).ready(function () {
    ...
    $("#bootstrap-slider1").slider();
    $("#bootstrap-slider1").on("slide", function (slideEvt) {
        $("#sliderValue1").text(slideEvt.value);
    });

    $('.slider').on("click", function () {
        var newvalue = $('.tooltip-inner').text();
        $("#sliderValue1").text(newvalue);
    });
...
$(document).ready(function () {
    ...
    $("#bootstrap-slider2").slider();
    $("#bootstrap-slider2").on("slide", function (slideEvt) {
        $("#sliderValue2").text(slideEvt.value);
    });

    $('.slider').on("click", function () {
        var newvalue = $('.tooltip-inner').text();
        $("#sliderValue2").text(newvalue);
    });
